...
**Veritext** is a cutting-edge Android application that uses on-device Artificial Intelligence to protect your inbox from spam, scams, and malicious text messages in real-time. By leveraging the power of **Gemma 4 LiteRT**, Veritext analyzes your incoming messages locally, ensuring your privacy remains completely intact while keeping you secure.
...
Unlike traditional cloud-based SMS scanners, Veritext uses local AI inference. This means your private messages are analyzed directly on your device's processor and are **never** sent to any external servers or APIs.
...
1. Clone this repository:
   ```bash
   git clone https://github.com/yourusername/Veritext.git
   ```
